...
import { TemplateControl, PrerenderedControls } from "./PrerenderedControl";
...
export var ServedCachedLocation = function (_a) {
...
var ClientCachedLocation = /** @class */ (function (_super) {
    __extends(ClientCachedLocation, _super);
    ...
    ClientCachedLocation.prototype.render = function () {
        ...
        if (variables) {
            return (React.createElement(Tag, { className: className },
                React.createElement(TemplateControl.Consumer, null, function (oldState) {
                    return React.createElement(TemplateControl.Provider, { value: __assign({ variables: __assign(__assign({}, oldState.variables), variables) }, oldState) }, children);
                })));
        }
...
export { ClientCachedLocation };
export var CachedLocation = function (_a) {
    ...
    return (React.createElement(UIDFork, null,
        React.createElement(PrerenderedControls, null, function (_a) {
            var control = _a.control, isServer = _a.isServer;
            if (!isServer && !clientCache || noCache || !control || !control.cache) {
                return children;
            }
            if (isServer) {
                return (React.createElement(ServedCachedLocation, { control: control, cacheKey: cacheKey, refresh: refresh, ttl: ttl, variables: variables }, children));
            }
            if (clientCache) {
