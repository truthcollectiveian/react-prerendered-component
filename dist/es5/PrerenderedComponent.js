...
var PrerenderedWrapper = /** @class */ (function (_super) {
    tslib_1.__extends(PrerenderedWrapper, _super);
    ...
    PrerenderedWrapper.prototype.render = function () {
        ...
        return (live || (!html && !strict))
            ? React.createElement(WrapperTag, tslib_1.__assign({}, props), children)
            : React.createElement(WrapperTag, tslib_1.__assign({}, props, { dangerouslySetInnerHTML: { __html: html || '' } }));
    };
...
var PrerenderedComponent = /** @class */ (function (_super) {
    tslib_1.__extends(PrerenderedComponent, _super);
    ...
    PrerenderedComponent.prototype.render = function () {
        ...
        return (React.createElement(PrerenderedControl_1.PrerenderedControls, null, function (_a) {
            ...
            return (React.createElement(react_uid_1.UIDFork, null,
                React.createElement(react_uid_1.UIDConsumer, null, function (uid) { return (React.createElement(PrerenderedWrapper, { id: "prc-" + uid, className: className, style: style, live: !!(live || isServer), strict: strict, dehydrate: _this.dehydrate, wrapperTag: wrapperTag },
                    store &&
...
exports.PrerenderedComponent = PrerenderedComponent;
